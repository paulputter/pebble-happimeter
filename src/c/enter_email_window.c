...
/* This class will be called, when the user has not
/  entered a valid email address in the app 
/  configuration. This class just shows a warning window
*/
...
static void window_load(Window *window) {
  ...
  s_icon_bitmap = gbitmap_create_with_resource(RESOURCE_ID_Very_Unhappy_Smiley_Emery);
  GRect bitmap_bounds = gbitmap_get_bounds(s_icon_bitmap);
